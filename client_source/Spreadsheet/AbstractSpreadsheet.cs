...
namespace SS
{
    ...
    public abstract class AbstractSpreadsheet
    {
        ...
        /// 
        /// Recursivly visits each dependent of a given cell and checks to see if that cell has allready been visited
        /// if it has, then a circular exception is thrown, if not returns all direct and indirect dependents of a cell. 
        /// </summary>
